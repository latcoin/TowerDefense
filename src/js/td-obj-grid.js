...
_TD.a.push(function (TD) {
	...
	var grid_obj = {
		...
		onClick: function () {
			...
			{
			    //console.log("build && this.map.is_main_map && !this.building");
			...
			{
			    //console.log("!this.building && this.map.selected_building");
				// 取消选中建筑
			...
			else
			{
			    ...
			    if (this.map.pre_building && !this.building && !this.checkBlock())
			    {
			        this.buyBuilding(this.map.pre_building.type);
			        //console.log("Buying building 2");
			    }
			}
		}
	};
